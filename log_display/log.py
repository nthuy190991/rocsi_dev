...
def sendCSS(filename):
    return send_from_directory(os.path.join(os.getcwd(), 'log_display', 'templates', 'css'), filename)

@app.route('/javascript/<path:filename>')
def sendJavascript(filename):
    return send_from_directory(os.path.join(os.getcwd(), 'log_display', 'templates', 'javascript'), filename)

@app.route('/images/<path:filename>')
def sendImages(filename):
    return send_from_directory(os.path.join(os.getcwd(), 'log_display', 'templates', 'images'), filename)
